...
export class PhenomenonDetection2Component implements OnInit {
    ...
    array: boolean[] = []; // It contains the selected filters
    ...
    getResults() {
        ...
        if (this.array[0] === false &&
            ...
            const content = {
                ...
                fire: this.array[0],
                flood: this.array[1],
                tornado: this.array[2],
                snow: this.array[3],
                rain: this.array[4],
                balllightning: this.array[5],
                hail: this.array[6],
                wind: this.array[7],
                pollution: this.array[8],
                ingredients: this.array[9],
                shape: this.shape,
                size: this.size,
                ...
                sea: this.sea,
                ashore: this.ashore,
                ashoreWithAltitude: this.ashoreWithAltitude,
